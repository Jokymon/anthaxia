#include "PsModelTreeView.h"
#include <QtGui>

PsModelTreeView::PsModelTreeView(QWidget* parent, PsModelControl* modelControl)
: QMainWindow(parent)
...
void PsModelTreeView::handleSimulationStopped()
{
    for (int i=0; i<mModelControl->getRegisterCount(); i++)
    {
        int registerValue;
...
void PsModelTreeView::handleSimulationReset()
{
...
void PsModelTreeView::handleModelChanged()
{
    updateRegisterDisplay();
}

#include "PsModelTreeView.moc"
